...
def sinkhorn(logits: Tensor, iterations: int = 10) -> Tensor:
    matrix = logits
    ...
    *,
    ...
    for _ in range(restarts):
        ...
        for _ in range(iterations):
            ...
            permutation = sinkhorn(permutation_logits, sinkhorn_iterations)
        ...
        with torch.no_grad():
            ...
            result = InversionResult(
                ...
                objective=float(
                    -torch.log(probabilities[0, target_class].clamp_min(1e-12))
                ),
            )
